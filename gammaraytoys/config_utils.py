...
def _quantity(block, key, where, unit, default = None, required = False,
    ...
    Both forms the schema allows are handed to `astropy.units.Quantity`
    whole: the scalar form (`"16 cm"`) and the array form
    (`"[30, 0, 1] cm"`). Whitespace inside the brackets is free, and
